...
Webflow.define('dropdown', module.exports = function ($, _) {
  ...
  function open(data) {
    ...
    if (!designer) $doc.on(mouseOrTap() + namespace, data.outside);
  ...
  function outside(data) {
    ...
    if (data.outside) $doc.off(mouseOrTap() + namespace, data.outside);
...
Webflow.require('ix').init([
  {"slug":"hide-slider-arrow","name":"Hide Slider Arrow","value":{"style":{"opacity":0.15000000000000005},"triggers":[]}},
  {"slug":"show-hero-slider-arrow","name":"Show Hero Slider Arrow","value":{"style":{},"triggers":[{"type":"hover","selector":".hero-slider-button","stepsA":[{"opacity":1,"transition":"opacity 400ms ease 0ms"}],"stepsB":[{"opacity":0.15000000000000005,"transition":"opacity 400ms ease 0ms"}]}]}},
  {"slug":"fill-slide-load-bar","name":"Fill Slide Load Bar","value":{"style":{},"triggers":[{"type":"slider","stepsA":[{"width":"100%","transition":"width 7000ms linear 0ms"}],"stepsB":[{"width":"10px"}]}]}},
  {"slug":"slide-title-1","name":"Slide Title 1","value":{"style":{"opacity":0,"x":"70px","y":"0px","z":"0px"},"triggers":[{"type":"slider","stepsA":[{"wait":400},{"opacity":1,"transition":"transform 500ms ease-in-out-quad 0ms, opacity 300ms ease-in-out-quad 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 200ms ease-in 0ms, opacity 200ms ease-in 0ms","x":"70px","y":"0px","z":"0px"}]}]}},
  {"slug":"slide-title-2","name":"Slide Title 2","value":{"style":{"opacity":0,"x":"70px","y":"0px","z":"0px"},"triggers":[{"type":"slider","stepsA":[{"wait":500},{"opacity":1,"transition":"transform 500ms ease-in-out-quad 0ms, opacity 500ms ease-in-out-quad 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 200ms ease-in 0ms, opacity 200ms ease-in 0ms","x":"70px","y":"0px","z":"0px"}]}]}},
  {"slug":"slide-title-3","name":"Slide Title 3","value":{"style":{"opacity":0,"x":"70px","y":"0px","z":"0px"},"triggers":[{"type":"slider","stepsA":[{"wait":600},{"opacity":1,"transition":"transform 500ms ease-in-out-quad 0ms, opacity 500ms ease-in-out-quad 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 200ms ease-in 0ms, opacity 200ms ease-in 0ms","x":"70px","y":"0px","z":"0px"}]}]}},
  {"slug":"slide-title-4","name":"Slide Title 4","value":{"style":{"opacity":0,"x":"70px","y":"0px","z":"0px"},"triggers":[{"type":"slider","stepsA":[{"wait":800},{"opacity":1,"transition":"transform 500ms ease-in-out-quad 0ms, opacity 500ms ease-in-out-quad 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 200ms ease-in 0ms, opacity 200ms ease-in 0ms","x":"70px","y":"0px","z":"0px"}]}]}},
  ...
  {"slug":"fade-in-on-load-3","name":"Fade in on Load 3","value":{"style":{"opacity":0,"x":"0px","y":"20px","z":"0px"},"triggers":[{"type":"load","stepsA":[{"wait":500},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"fade-in-on-load-4","name":"Fade in on Load 4","value":{"style":{"opacity":0,"x":"0px","y":"20px","z":"0px"},"triggers":[{"type":"load","stepsA":[{"wait":1000},{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}}
]);
