...
Webflow.require('ix').init([
  {"slug":"hide-slider-arrow","name":"Hide Slider Arrow","value":{"style":{"opacity":0.15000000000000008},"triggers":[]}},
  {"slug":"show-hero-slider-arrow","name":"Show Hero Slider Arrow","value":{"style":{},"triggers":[{"type":"hover","selector":".hero-slider-button","stepsA":[{"opacity":1,"transition":"opacity 400ms ease 0ms"}],"stepsB":[{"opacity":0.15000000000000008,"transition":"opacity 400ms ease 0ms"}]}]}},
  {"slug":"fill-slide-load-bar","name":"Fill Slide Load Bar","value":{"style":{},"triggers":[{"type":"slider","stepsA":[{"width":"100%","transition":"width 12000ms linear 0ms"}],"stepsB":[{"width":"10px"}]}]}},
