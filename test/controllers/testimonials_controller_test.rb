...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { body: @testimonial.body, cloudy_id: @testimonial.cloudy_id, member_id: @testimonial.member_id, title: @testimonial.title } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { body: @testimonial.body, cloudy_id: @testimonial.cloudy_id, member_id: @testimonial.member_id, title: @testimonial.title } }
